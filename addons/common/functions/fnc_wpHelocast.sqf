...
[
	_vehicle,
	[_vehicle,ATLtoASL waypointPosition [_group,currentWaypoint _group],"SEA",_driftHeight] call FUNC(heliSurfacePosASL),
	[_endDir,1.5],
	(getPos _vehicle # 2) max 50,
	_approach,
	nil,
	[FUNC(pilotHelicopterHelocast),[_timeout,_driftHeight,_driftSpeed,[]]]
